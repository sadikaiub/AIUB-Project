...
if(isset($_POST["submit"])){
    if (isset($_POST["name"]) && isset($_POST["email"]) && isset($_POST["arrivaldate"]) && isset($_POST["departuredate"]) && isset($_POST["roomtype"]) && isset($_POST["person"])  && isset($_POST["totalamount"]) && isset($_POST["bookingstatus"])) {
        //echo "working";
        $name=$_POST['name'];
        $email=$_POST['email'];
